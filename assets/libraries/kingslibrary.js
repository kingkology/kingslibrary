	    ...
	    .done(function(rs, textStatus, xhr) 
	    {
	        ...
	        if (response_length>1) 
	        {
	        	...
	        	else
	        	{
	        		...
	        		table_body=table_body+'<tr><td colspan=2><button type="button" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-arrow-left" onclick="create_table(\''+url+'\',\''+display_location+'\','+old_start+','+limit+')"></i></button><button type="button" class="btn btn-sm btn-info waves-effect waves-light" onclick="create_table(\''+url+'\',\''+display_location+'\','+new_start+','+limit+')"><i class="mdi mdi-arrow-right-bold"></i></button></tr></td></tbody>';
	        	}
